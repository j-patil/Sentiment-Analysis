	...
	public static class TokenizerMapper extends Mapper < Object, Text, Text, Text > {
	  ...
	  public void map(Object key, Text value, Context context) throws IOException,InterruptedException {
	   ...
	   sc = new Scanner(new File("/home/rutesh/workspace/ProductSentiment/lib/Camera.txt"));
	   while (sc.hasNext()) {
	    Camera.add(sc.next());
	   }
	   sc.close();
	   ...
	   sc = new Scanner(new File("/home/rutesh/workspace/ProductSentiment/lib/Display.txt"));
	   while (sc.hasNext()) {
	    Display.add(sc.next());
	   }
	   sc.close();
	   ...
	   sc = new Scanner(new File("/home/rutesh/workspace/ProductSentiment/lib/Processor.txt"));
	   while (sc.hasNext()) {
	   ...
	   sc = new Scanner(new File("/home/rutesh/workspace/ProductSentiment/lib/Memory.txt"));
	   while (sc.hasNext()) {
	    Memory.add(sc.next());
	   }
	   sc.close();
	   ...
	   sc = new Scanner(new File("/home/rutesh/workspace/ProductSentiment/lib/Sound.txt"));
	   while (sc.hasNext()) {
	    Sound.add(sc.next());
	   }
	   sc.close();
	   ...
	   sc = new Scanner(new File("/home/rutesh/workspace/ProductSentiment/lib/Battery.txt"));
	   while (sc.hasNext()) {
	    Battery.add(sc.next());
	   }
	   sc.close();
	...
	public static class TokenizerReducer extends Reducer < Text, Text, Text, Text > {
	  ...
	  public static String stringTag(String i) {
	   ...
	   POSModel model = null;
	   try {
	    modelIn = new FileInputStream("/home/rutesh/workspace/ProductSentiment/open_nlp/en-pos-maxent.bin");
